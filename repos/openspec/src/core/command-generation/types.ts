...
/**
 * Install context passed through the command generation pipeline.
 * Carries the resolved scope so adapters can produce the correct path.
 */
export interface InstallContext {
  /** The resolved install scope for this command surface */
  scope: InstallScope;
}
...
export interface ToolCommandAdapter {
   ...
   *                  When omitted, adapters should default to 'project' scope.
