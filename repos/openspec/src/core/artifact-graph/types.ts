...
export const ChangeMetadataSchema = z.object({
  ...
  // --- Stack metadata (optional, for change stacking / dependency awareness) ---

  // Names of other changes that must land before this one
  dependsOn: z.array(z.string().min(1)).optional(),

  // Capabilities or interfaces this change provides to dependents
  provides: z.array(z.string().min(1)).optional(),

  // Capabilities or preconditions this change requires from its environment
  requires: z.array(z.string().min(1)).optional(),

  // File paths or modules this change touches (for conflict detection)
  touches: z.array(z.string().min(1)).optional(),

  // Parent change name — identifies this change as a slice of a larger change
