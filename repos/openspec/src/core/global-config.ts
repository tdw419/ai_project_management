...
export function getGlobalConfig(): GlobalConfig {
  ...
  try {
    ...
    // Legacy configs without installScope should NOT get 'global' default —
    // they predate the concept and the effective value is 'project'.
    // New configs (no file on disk) get 'global' via DEFAULT_CONFIG above.
    if (parsed.installScope === undefined) {
      merged.installScope = undefined;
    }
