...
describe('migration', () => {
  ...
  it('sets installScope to project during migration for legacy users', async () => {
    // Legacy config: has delivery but no profile or installScope
    saveGlobalConfig({
      featureFlags: {},
      delivery: 'skills',
    });
  ...
  it('preserves explicit installScope during migration', async () => {
    saveGlobalConfig({
      featureFlags: {},
      delivery: 'both',
      installScope: 'global',
